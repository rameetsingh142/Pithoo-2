...
class _BlePageState extends State<BlePage> {
  ...
  double goodPostureRoll = 0.0;
  double goodPosturePitch = 0.0;
  double badPostureRoll = 0.0;
  double badPosturePitch = 0.0;
  bool isGoodPostureCalibrated = false;
  bool isBadPostureCalibrated = false;
  ...
  void startCalibrationFlow() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => GoodPostureCalibrationScreen(
          characteristic: characteristic!,
          onCalibrationComplete: (roll, pitch) {
            setState(() {
              goodPostureRoll = roll;
              goodPosturePitch = pitch;
              isGoodPostureCalibrated = true;
            });
          },
          onBadPostureComplete: (roll, pitch) {
            setState(() {
              badPostureRoll = roll;
              badPosturePitch = pitch;
              isBadPostureCalibrated = true;
            });
          },
        ),
      ),
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: startCalibrationFlow,
              style: ElevatedButton.styleFrom(
            ...
            if (isGoodPostureCalibrated || isBadPostureCalibrated)
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Column(
                  children: [
                    if (isGoodPostureCalibrated)
                      Container(
